...
**[To Do List]** This is a mini app in which the user can add, edit, complete or delete tasks. And user can also clear all the completed tasks.
...
```sh
  cd my-folder
  git clone https://github.com/sahlminkok/To-Do-List.git
```
-
...
Feel free to check the [issues page] (https://github.com/sahlminkok/To-Do-List.git/issues).
